...
Singleton {
    ...
    Process {
        id: proc
        command: {
            const cur = ["temperature_2m", "apparent_temperature", "relative_humidity_2m", "weathercode", "windspeed_10m", "winddirection_10m", "precipitation", "is_day", "uv_index", "cloud_cover"].join(",");
