...
* Autostart programs 
 ...
 exec-once =  waybar & dunst & nm-applet --indicator & blueman-applet & emacs --daemon & foot --server & swaybg -i ~/dotfiles/wallpapers/NixOS-1.png & bash ~/dotfiles/scripts/power-monitor.sh
 #+end_src
* Input settings
** General settings
#+begin_src conf
