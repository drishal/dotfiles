...
* Autostart programs 
 ...
 exec-once =  waybar & dunst & nm-applet --indicator & lxpolkit & blueman-applet & emacs --daemon & /usr/bin/foot --server  & hyprpaper
...
** Binds
#+begin_src conf
bind = $mainMod, RETURN, exec, /usr/bin/footclient
