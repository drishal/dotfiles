...
#+begin_src emacs-lisp
  ...
  (use-package doom-themes :straight t
    ...
    (setq doom-themes-treemacs-theme "doom-dracula") ; use the colorful treemacs theme
...
#+begin_src emacs-lisp
  (unless (file-exists-p "~/.emacs-temp")
    (mkdir "~/.emacs-temp/backups"))
  (setq backup-directory-alist `(("." . ,(expand-file-name "~/.emacs-temp/backups" ))))
#+end_src

*** Autosave directory
#+begin_src emacs-lisp
  ;; (unless (file-exists-p "~/.emacs-temp/auto-saves")
  ;;   (mkdir "~/.emacs-temp/auto-saves")
  ;;   (mkdir "~/.emacs-temp/auto-saves/sessions"))

  ;; (setq auto-save-file-name-transforms
  ;;       `((".*" ,(no-littering-expand-var-file-name "~/.emacs-temp/auto-saves/") t)))
#+end_src
